...
const Footer = () => {
  ...
  if(path.match("studio")){
    ...
    return (
        <>
        {/* Footer 1 */}
        <div className="footer1 bg-base-200 w-full mb-4">
            <div className="grid grid-cols-3 ml-[5%]">
                <div className="grid grid-cols-1 border border-r-gray-200 border-b-transparent border-l-transparent border-t-transparent">
                    <div>
                        <Image className="mx-auto" width={100} height={100} src="/img/support.gif" alt="Customer Support" />
                    </div>
                ...
                <div className="grid grid-cols-1 border border-r-gray-200 border-b-transparent border-l-transparent border-t-transparent">
                    <div>
                        <Image className="mx-auto" width={100} height={100} src="/img/delivery.gif" alt="Customer Support" />
                    </div>
                    <div className="assist">
                        Free Delivery
                    </div>
                ...
                <div className="grid grid-cols-1 border border-r-gray-200 border-b-transparent border-l-transparent border-t-transparent">
                    <div>
                        <Image className="mx-auto" width={100} height={100} src="/img/return.gif" alt="Customer Support" />
                    </div>
                    <div className="assist">
                        7 Days Return
                    </div>
        ...
        {/* Footer 2 */}
        <footer className="footer grid grid-cols-2 lg:grid-cols-3 p-10 bg-gradient-to-r from-indigo-400 to-cyan-400 text-white">
  <div>
...
<footer className="footer px-10 py-4 border-t bg-gradient-to-r from-indigo-400 to-cyan-400 text-white border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p>Supernova store <br/>All the things you need</p>
  </div> 
